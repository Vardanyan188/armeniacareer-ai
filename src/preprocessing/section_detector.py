...
SECTION_ALIASES: Dict[str, List[str]] = {
    ...
    "contact": [
        "contact", "contacts", "contact information", "contact details", "personal information",
        "կոնտակտ", "կոնտակտներ", "կոնտակտային տվյալներ", "անձնական տվյալներ",
    ...
    "education": [
        ...
        "կրթություն", "ակադեմիական կրթություն", "ուսում",
        "образование", "учёба", "учеба", "академическое образование",
    ],
    "skills": [
        "skills", "technical skills", "core competencies", "competencies", "expertise",
        "tech stack", "technologies",
        "հմտություններ", "տեխնիկական հմտություններ", "կարողություններ", "մասնագիտական հմտություններ",
        "навыки", "технические навыки", "компетенции", "умения", "ключевые навыки",
    ],
    "languages": [
        "languages", "language skills", "language proficiency",
        "լեզուներ", "լեզվի իմացություն", "լեզուների իմացություն",
